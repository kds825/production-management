...
# _is_core_group, _st_sq 는 app.services.scheduling_shared.group_ops 로 이동
...
# _is_sheath_group 은 app.services.scheduling_shared.group_ops 로 이동
# (Week 3 Task 3A.1). 아래 import 가 모듈 namespace 에 re-export (D7-C).
from app.services.scheduling_shared.group_ops import (  # noqa: E402, F401
...
# _extract_core_main_sq 는 app.services.scheduling_shared.group_ops 로 이동
# (Week 3 Task 3A.1). 아래 import 가 모듈 namespace 에 re-export (D7-C).
from app.services.scheduling_shared.group_ops import (  # noqa: E402, F401
...
# _SHEATH_ROUTING 과 _get_sheath_type 은 schedule_optimizer 에 남아 있어
# 이동된 함수가 지역 import 로 다시 가져온다.
from app.services.scheduling_shared.slot_filters import (  # noqa: E402, F401
