...
import type { ScheduleDiffResponse } from "@/features/scheduler/types/diff";
        ...
        >
          {(
            ...
            <button
              ...
              style={{
                backgroundColor:
                  uploadMode === value ? PRIMARY : "var(--bg-surface)",
                color:
                  uploadMode === value
                    ? "var(--bg-surface)"
                    : "var(--neutral-600)",
        ...
        >
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              style={{
                backgroundColor:
                  isRunning || result ? "var(--color-border-default)" : PRIMARY,
                color:
                  isRunning || result
